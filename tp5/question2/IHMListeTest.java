...
public class IHMListeTest extends junit.framework.TestCase{
     ...
     *
     * Méthode appelée aprês chaque appel de méthode de test.
     */
    ...
    public void test_IHMListe_retirer_et_occurrence() {
        try{
            ...
            try{
                ...
                assertTrue(" Nombre d'occurrence de linked est-il erroné ??? (0 aprês un retrait)",result==0);
            }catch(java.util.InputMismatchException e){
                fail("L'affichage du nombre d'occurrence doit être de 0 aprês un retrait effectif");
            }
